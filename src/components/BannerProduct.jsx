                    ...
                    <SwiperSlide style={{ backgroundImage: `url(${deskVerde})` }} className="bg-cover bg-center">
                        <div  className="w-full lg:w-1/2 h-full  flex items-center justify-center">
                            <div className="lg:w-[75%] flex flex-col items-center p-5 rounded backdrop-blur-sm bg-">
                                <h1 className="text-[60px] text-white text-center animationText3D">Farinha de Camarão</h1>
                                <p className=" w-[90%] lg:w-2/3 text-white text-lg">
                                ...
                                <div className="p-[3px] w-max mt-8 bg-gradient-to-tl from-green-600 to-yellow-500 rounded-2xl">
                                    <a href="#farinhaCamarao" type="button" className="bg-white  py-5 px-8 rounded-2xl hover:bg-gradient-to-tl from-green-600 to-yellow-500 hover:text-white font-bold transition-all duration-500" >
                                        Learn About
                                    </a>
                                </div>
                            </div>
                    ...
                    <SwiperSlide style={{ backgroundImage: `url(${deskLaranja})` }} className="bg-cover bg-center">
                        <div  className="w-full lg:w-1/2 h-full  flex items-center justify-center">
                            <div className="lg:w-[75%] flex flex-col items-center p-5 rounded backdrop-blur-sm">
                                <h1 className="text-[60px] text-white text-center animationText3D">Farinha e Atum</h1>
                                <p className="w-[90%] lg:w-2/3 text-white text-lg">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, facere fuga. Animi sapiente architecto excepturi facilis assumenda? Magni impedit sed nesciunt vitae autem harum esse eaque, laudantium accusantium quis veniam!
                                </p>
                                <div className="p-[3px] w-max mt-8 bg-gradient-to-tl from-green-600 to-yellow-500 rounded-2xl">
                                    <a href="#farinhaAtum" type="button" className="bg-white  py-5 px-8 rounded-2xl hover:bg-gradient-to-tl from-green-600 to-yellow-500 hover:text-white font-bold transition-all duration-500" >
                                        Learn About
                                    </a>
                                </div>
                            </div>
            ...
            <section className="lg:hidden">
                ...
                >
                    <SwiperSlide style={{ backgroundImage: `url(${mobVerde})` }} className="bg-cover bg-center">
                        <div  className="w-full lg:w-1/2 h-full  flex items-center justify-center">
                            <div className="lg:w-[75%] flex flex-col items-center p-5 rounded backdrop-blur-sm bg-">
                                ...
                                <div className="p-[3px] w-max mt-8 bg-gradient-to-tl from-green-600 to-[#ec5f1a] rounded-2xl">
                                    <a href="#farinhaCamarao" type="button" className="bg-white  py-5 px-8 rounded-2xl hover:bg-gradient-to-tl from-green-600 to-yellow-500 hover:text-white font-bold transition-all duration-500" >
                                        Saiba mais
                                    </a>
                                </div>
                    ...
                    <SwiperSlide style={{ backgroundImage: `url(${mobLaranja})` }} className="bg-cover bg-center">
                        <div  className="w-full lg:w-1/2 h-full  flex items-center justify-center">
                            <div className="lg:w-[75%] flex flex-col items-center p-5 rounded backdrop-blur-sm">
                                <h1 className="text-[60px] text-white text-center animationText3D">Farinha de Atum</h1>
                                <p className="w-[90%] lg:w-2/3 text-white text-xl">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, facere fuga. Animi sapiente architecto excepturi facilis assumenda? Magni impedit sed nesciunt vitae autem harum esse eaque, laudantium accusantium quis veniam!
                                </p>
                                <div className="p-[3px] w-max mt-8 bg-gradient-to-tl from-green-600 to-[#ec5f1a] rounded-2xl">
